...
class OrderResource extends Resource
{
    ...
    {
        return auth()->user()?->hasRole('imalathane') ? false : parent::canCreate();
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()?->hasRole('imalathane') ? false : parent::canEdit($record);
    }

    public static function canDelete(Model $record): bool
    {
        return auth()->user()?->hasRole('imalathane') ? false : parent::canDelete($record);
    }

    public static function getNavigationGroup(): ?string
    {
        return auth()->user()?->hasRole('imalathane') ? 'İmalathane' : 'Satış';
    }
