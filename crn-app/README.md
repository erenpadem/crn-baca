...
# .env içinde APP_KEY=base64:... ekleyin (php artisan key:generate ile üretin)
docker compose up -d
...
```bash
cp .env.example .env
# .env içinde DB_CONNECTION=mysql, DB_HOST=127.0.0.1, DB_DATABASE=crn_baca vb. ayarlayın
